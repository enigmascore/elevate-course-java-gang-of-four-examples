 ...
 * is determined by the current annual Salary.  This state object will be automatically upgraded
 * to a PremiereAccountState if the salary rises to or above the salary defined in the enum:
 * <p>
 ...
 */
public final class StandardAccountState extends AbstractAccountState {

    /**
     * Creates a StandardAccountState with the given salary and balance.
     *
     * @param salary
     ...
     */
    public StandardAccountState( int salary, BigDecimal balance ) {
