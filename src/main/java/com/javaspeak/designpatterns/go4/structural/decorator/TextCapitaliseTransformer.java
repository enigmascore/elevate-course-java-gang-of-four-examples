...
/**
 * This class is a Decorator which converts its input to upper case. It holds a reference to
 * another decorator. The decorators implement Transformer.  The reference to another decorator
 * can be added by calling addDecoration( {@code Transformer<String>} transformer ).
 * <p>
...
public class TextCapitaliseTransformer implements Transformer<String> {
     ...
     */
    public TextCapitaliseTransformer() {
    }
